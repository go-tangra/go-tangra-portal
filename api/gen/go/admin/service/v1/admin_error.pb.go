...
const (
	// 400
	AdminErrorReason_BAD_REQUEST        AdminErrorReason = 0 // Bad request
	AdminErrorReason_INVALID_GRANT_TYPE AdminErrorReason = 1 // Invalid grant type
	AdminErrorReason_INVALID_USERID     AdminErrorReason = 2 // Invalid user ID
	AdminErrorReason_INVALID_TOKEN      AdminErrorReason = 3 // Invalid token
	AdminErrorReason_INVALID_PASSWORD   AdminErrorReason = 4 // Invalid password
	// 401
	AdminErrorReason_UNAUTHORIZED            AdminErrorReason = 100 // Unauthorized
	AdminErrorReason_USER_FREEZE             AdminErrorReason = 101 // User is frozen
	AdminErrorReason_INCORRECT_PASSWORD      AdminErrorReason = 102 // Incorrect password
	AdminErrorReason_INCORRECT_APP_SECRET    AdminErrorReason = 103 // Incorrect app secret
	AdminErrorReason_INCORRECT_ACCESS_TOKEN  AdminErrorReason = 104 // Incorrect access token
	AdminErrorReason_INCORRECT_REFRESH_TOKEN AdminErrorReason = 105 // Incorrect refresh token
	AdminErrorReason_TOKEN_EXPIRED           AdminErrorReason = 106 // Token expired
	AdminErrorReason_TOKEN_NOT_EXIST         AdminErrorReason = 107 // Token does not exist
	// 402
	AdminErrorReason_PAYMENT_REQUIRED AdminErrorReason = 200 // Payment required
	// 403
	AdminErrorReason_FORBIDDEN AdminErrorReason = 300 // Access forbidden
	// 404
	AdminErrorReason_NOT_FOUND        AdminErrorReason = 400 // Resource not found
	AdminErrorReason_USER_NOT_FOUND   AdminErrorReason = 401 // User not found
	AdminErrorReason_MODULE_NOT_FOUND AdminErrorReason = 402 // Dynamic module not found
	// 405
	AdminErrorReason_METHOD_NOT_ALLOWED AdminErrorReason = 500 // Method not allowed
	// 406
	AdminErrorReason_NOT_ACCEPTABLE AdminErrorReason = 600 // Not acceptable request
	// 407
	AdminErrorReason_PROXY_AUTHENTICATION_REQUIRED AdminErrorReason = 700 // Proxy authentication required
	// 408
	AdminErrorReason_REQUEST_TIMEOUT AdminErrorReason = 800 // Request timeout
	// 409
	AdminErrorReason_CONFLICT AdminErrorReason = 900 // Conflict
	// 410
	AdminErrorReason_GONE AdminErrorReason = 1000 // Gone (deleted)
	// 411
	AdminErrorReason_LENGTH_REQUIRED AdminErrorReason = 1010 // Content-Length required
	// 412
	AdminErrorReason_PRECONDITION_FAILED AdminErrorReason = 1020 // Precondition failed
	// 413
	AdminErrorReason_PAYLOAD_TOO_LARGE AdminErrorReason = 1030 // Payload too large
	// 414
	AdminErrorReason_URI_TOO_LONG AdminErrorReason = 1040 // URI too long
	// 415
	AdminErrorReason_UNSUPPORTED_MEDIA_TYPE AdminErrorReason = 1050 // Unsupported media type
	// 416
	AdminErrorReason_RANGE_NOT_SATISFIABLE AdminErrorReason = 1060 // Range not satisfiable
	// 417
	AdminErrorReason_EXPECTATION_FAILED AdminErrorReason = 1070 // Expectation failed
	// 418
	AdminErrorReason_IM_A_TEAPOT AdminErrorReason = 1080 // I'm a teapot (RFC 2324)
	// 421
	AdminErrorReason_MISDIRECTED_REQUEST AdminErrorReason = 1090 // Misdirected request
	// 422
	AdminErrorReason_UNPROCESSABLE_ENTITY AdminErrorReason = 1100 // Unprocessable entity
	// 423
	AdminErrorReason_LOCKED AdminErrorReason = 1110 // Locked
	// 424
	AdminErrorReason_FAILED_DEPENDENCY AdminErrorReason = 1120 // Failed dependency
	// 425
	AdminErrorReason_TOO_EARLY AdminErrorReason = 1130 // Too early
	// 426
	AdminErrorReason_UPGRADE_REQUIRED AdminErrorReason = 1140 // Upgrade required
	// 428
	AdminErrorReason_PRECONDITION_REQUIRED AdminErrorReason = 1150 // Precondition required
	// 429
	AdminErrorReason_TOO_MANY_REQUESTS AdminErrorReason = 1160 // Too many requests
	// 431
	AdminErrorReason_REQUEST_HEADER_FIELDS_TOO_LARGE AdminErrorReason = 1170 // Request header fields too large
	// 451
	AdminErrorReason_UNAVAILABLE_FOR_LEGAL_REASONS AdminErrorReason = 1180 // Unavailable for legal reasons
	// 500
	AdminErrorReason_INTERNAL_SERVER_ERROR AdminErrorReason = 2000 // Internal server error
	// 501
	AdminErrorReason_NOT_IMPLEMENTED AdminErrorReason = 2100 // Not implemented
	// 502
	AdminErrorReason_BAD_GATEWAY AdminErrorReason = 2200 // Bad gateway
	// 503
	AdminErrorReason_SERVICE_UNAVAILABLE AdminErrorReason = 2300 // Service unavailable
	// 504
	AdminErrorReason_GATEWAY_TIMEOUT AdminErrorReason = 2400 // Gateway timeout
	// 505
	AdminErrorReason_HTTP_VERSION_NOT_SUPPORTED AdminErrorReason = 2500 // HTTP version not supported
	// 506
	AdminErrorReason_VARIANT_ALSO_NEGOTIATES AdminErrorReason = 2600 // Variant also negotiates
	// 507
	AdminErrorReason_INSUFFICIENT_STORAGE AdminErrorReason = 2700 // Insufficient storage
	// 508
	AdminErrorReason_LOOP_DETECTED AdminErrorReason = 2800 // Loop detected
	// 510
	AdminErrorReason_NOT_EXTENDED AdminErrorReason = 2900 // Not extended
	// 511
	AdminErrorReason_NETWORK_AUTHENTICATION_REQUIRED AdminErrorReason = 3000 // Network authentication required
	// 598
	AdminErrorReason_NETWORK_READ_TIMEOUT_ERROR AdminErrorReason = 3100 // Network read timeout
	// 599
	AdminErrorReason_NETWORK_CONNECT_TIMEOUT_ERROR AdminErrorReason = 3200 // Network connect timeout
)
...
const file_admin_service_v1_admin_error_proto_rawDesc = "" +
	"\n" +
	"\"admin/service/v1/admin_error.proto\x12\x10admin.service.v1\x1a\x13errors/errors.proto*\x81\r\n" +
	...
	"\x10MODULE_NOT_FOUND\x10\x92\x03\x1a\x04\xa8E\x94\x03\x12\x1d\n" +
	...
	"\x14com.admin.service.v1B\x0fAdminErrorProtoP\x01ZIgithub.com/go-tangra/go-tangra-portal/api/gen/go/admin/service/v1;adminpb\xa2\x02\x03ASX\xaa\x02\x10Admin.Service.V1\xca\x02\x10Admin\\Service\\V1\xe2\x02\x1cAdmin\\Service\\V1\\GPBMetadata\xea\x02\x12Admin::Service::V1b\x06proto3"
