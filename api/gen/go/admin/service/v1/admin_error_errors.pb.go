...
// Dynamic module not found
func IsModuleNotFound(err error) bool {
	if err == nil {
		return false
	}
	e := errors.FromError(err)
	return e.Reason == AdminErrorReason_MODULE_NOT_FOUND.String() && e.Code == 404
}

// Dynamic module not found
func ErrorModuleNotFound(format string, args ...interface{}) *errors.Error {
	return errors.New(404, AdminErrorReason_MODULE_NOT_FOUND.String(), fmt.Sprintf(format, args...))
}
