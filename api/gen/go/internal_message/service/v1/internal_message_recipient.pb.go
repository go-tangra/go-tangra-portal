...
const (
	InternalMessageRecipient_SENT     InternalMessageRecipient_Status = 0 // (System status) Message stored in recipient inbox, waiting for client to fetch
	InternalMessageRecipient_RECEIVED InternalMessageRecipient_Status = 1 // (Client receipt) Recipient client has successfully received/downloaded the message
	InternalMessageRecipient_READ     InternalMessageRecipient_Status = 2 // (Client receipt) Recipient has read the message
	InternalMessageRecipient_REVOKED  InternalMessageRecipient_Status = 3 // (Sender action) Message revoked by sender
	InternalMessageRecipient_DELETED  InternalMessageRecipient_Status = 4 // (Recipient action) Recipient deleted this message
)
...
type InternalMessageRecipient struct {
	...
	Id              *uint32                          `protobuf:"varint,1,opt,name=id,proto3,oneof" json:"id,omitempty"`                                                                          // Record ID
	MessageId       *uint32                          `protobuf:"varint,2,opt,name=message_id,json=messageId,proto3,oneof" json:"message_id,omitempty"`                                           // Internal message content ID
	RecipientUserId *uint32                          `protobuf:"varint,3,opt,name=recipient_user_id,json=recipientUserId,proto3,oneof" json:"recipient_user_id,omitempty"`                       // Recipient user ID
	Status          *InternalMessageRecipient_Status `protobuf:"varint,4,opt,name=status,proto3,enum=internal_message.service.v1.InternalMessageRecipient_Status,oneof" json:"status,omitempty"` // Message status
	ReceivedAt      *timestamppb.Timestamp           `protobuf:"bytes,5,opt,name=received_at,json=receivedAt,proto3,oneof" json:"received_at,omitempty"`                                         // Time when message arrived in user inbox
	ReadAt          *timestamppb.Timestamp           `protobuf:"bytes,6,opt,name=read_at,json=readAt,proto3,oneof" json:"read_at,omitempty"`                                                     // Time when user read the message
	Title           *string                          `protobuf:"bytes,10,opt,name=title,proto3,oneof" json:"title,omitempty"`                                                                    // Message title
	Content         *string                          `protobuf:"bytes,11,opt,name=content,proto3,oneof" json:"content,omitempty"`                                                                // Message content
...
type DeleteNotificationFromInboxRequest struct {
	...
	RecipientIds  []uint32               `protobuf:"varint,2,rep,packed,name=recipient_ids,json=recipientIds,proto3" json:"recipient_ids,omitempty"` // List of inbox record IDs
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type MarkNotificationsStatusRequest struct {
	...
	UserId        uint32                          `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`                                                                           // User ID
	RecipientIds  []uint32                        `protobuf:"varint,2,rep,packed,name=recipient_ids,json=recipientIds,proto3" json:"recipient_ids,omitempty"`                                                  // List of inbox record IDs
	NewStatus     InternalMessageRecipient_Status `protobuf:"varint,3,opt,name=new_status,json=newStatus,proto3,enum=internal_message.service.v1.InternalMessageRecipient_Status" json:"new_status,omitempty"` // New message status
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_message_service_v1_internal_message_recipient_proto_rawDesc = "" +
	"\n" +
	"<internal_message/service/v1/internal_message_recipient.proto\x12\x1binternal_message.service.v1\x1a$gnostic/openapi/v3/annotations.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a google/protobuf/field_mask.proto\x1a\x1epagination/v1/pagination.proto\"\xd4\v\n" +
	"\x18InternalMessageRecipient\x12$\n" +
	"\x02id\x18\x01 \x01(\rB\x0f\xbaG\f\x92\x02\tRecord IDH\x00R\x02id\x88\x01\x01\x12E\n" +
	"\n" +
	"message_id\x18\x02 \x01(\rB!\xbaG\x1e\x92\x02\x1bInternal message content IDH\x01R\tmessageId\x88\x01\x01\x12H\n" +
	"\x11recipient_user_id\x18\x03 \x01(\rB\x17\xbaG\x14\x92\x02\x11Recipient user IDH\x02R\x0frecipientUserId\x88\x01\x01\x12o\n" +
	"\x06status\x18\x04 \x01(\x0e2<.internal_message.service.v1.InternalMessageRecipient.StatusB\x14\xbaG\x11\x92\x02\x0eMessage statusH\x03R\x06status\x88\x01\x01\x12o\n" +
	"\vreceived_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampB-\xbaG*\x92\x02'Time when message arrived in user inboxH\x04R\n" +
	"receivedAt\x88\x01\x01\x12_\n" +
	"\aread_at\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampB%\xbaG\"\x92\x02\x1fTime when user read the messageH\x05R\x06readAt\x88\x01\x01\x12.\n" +
	"\x05title\x18\n" +
	" \x01(\tB\x13\xbaG\x10\x92\x02\rMessage titleH\x06R\x05title\x88\x01\x01\x124\n" +
	"\acontent\x18\v \x01(\tB\x15\xbaG\x12\x92\x02\x0fMessage contentH\aR\acontent\x88\x01\x01\x12R\n" +
	"\ttenant_id\x18( \x01(\rB0\xbaG-\x92\x02*Tenant ID, 0 represents system global roleH\bR\btenantId\x88\x01\x01\x127\n" +
	"\vtenant_name\x18) \x01(\tB\x11\xbaG\x0e\x92\x02\vTenant nameH\tR\n" +
	...
	"\n" +
	"deleted_at\x18\xca\x01 \x01(\v2\x1a.google.protobuf.TimestampB\x12\xbaG\x0f\x92\x02\fDeleted timeH\x0fR\tdeletedAt\x88\x01\x01\"D\n" +
	"\x06Status\x12\b\n" +
	...
	"\x04data\x18\x01 \x01(\v25.internal_message.service.v1.InternalMessageRecipientR\x04data\"\xc5\x03\n" +
	...
	"\x92\x02\aUser IDR\x06userId\x12C\n" +
	"\rrecipient_ids\x18\x02 \x03(\rB\x1e\xbaG\x1b\x92\x02\x18List of inbox record IDsR\frecipientIds\"\x8c\x01\n" +
	"\x1dMarkNotificationAsReadRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\rB\r\xbaG\n" +
	"\x92\x02\aUser IDR\x06userId\x12C\n" +
	"\rrecipient_ids\x18\x02 \x03(\rB\x1e\xbaG\x1b\x92\x02\x18List of inbox record IDsR\frecipientIds\"\x84\x02\n" +
	"\x1eMarkNotificationsStatusRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\rB\r\xbaG\n" +
	"\x92\x02\aUser IDR\x06userId\x12C\n" +
	"\rrecipient_ids\x18\x02 \x03(\rB\x1e\xbaG\x1b\x92\x02\x18List of inbox record IDsR\frecipientIds\x12u\n" +
	"\n" +
	"new_status\x18\x03 \x01(\x0e2<.internal_message.service.v1.InternalMessageRecipient.StatusB\x18\xbaG\x15\x92\x02\x12New message statusR\tnewStatus2\xca\t\n" +
	...
	"\x17MarkNotificationsStatus\x12;.internal_message.service.v1.MarkNotificationsStatusRequest\x1a\x16.google.protobuf.EmptyB\xaa\x02\n" +
	"\x1fcom.internal_message.service.v1B\x1dInternalMessageRecipientProtoP\x01Z^github.com/go-tangra/go-tangra-portal/api/gen/go/internal_message/service/v1;internalmessagepb\xa2\x02\x03ISX\xaa\x02\x1aInternalMessage.Service.V1\xca\x02\x1aInternalMessage\\Service\\V1\xe2\x02&InternalMessage\\Service\\V1\\GPBMetadata\xea\x02\x1cInternalMessage::Service::V1b\x06proto3"
