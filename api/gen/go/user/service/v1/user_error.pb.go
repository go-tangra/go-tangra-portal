...
const (
	// 400
	UserErrorReason_BAD_REQUEST      UserErrorReason = 0 // Bad request
	UserErrorReason_INVALID_USERID   UserErrorReason = 1 // Invalid user ID
	UserErrorReason_INVALID_PASSWORD UserErrorReason = 2 // Invalid password
	// 401
	UserErrorReason_UNAUTHORIZED       UserErrorReason = 100 // Unauthorized
	UserErrorReason_USER_FREEZE        UserErrorReason = 101 // User frozen
	UserErrorReason_INCORRECT_PASSWORD UserErrorReason = 102 // Incorrect password
	// 402
	UserErrorReason_PAYMENT_REQUIRED UserErrorReason = 200 // Payment required
	// 403
	UserErrorReason_FORBIDDEN UserErrorReason = 300 // Forbidden
	// 404
	UserErrorReason_NOT_FOUND              UserErrorReason = 400 // Resource not found
	UserErrorReason_USER_NOT_FOUND         UserErrorReason = 401 // User not found
	UserErrorReason_ROLE_NOT_FOUND         UserErrorReason = 402 // Role not found
	UserErrorReason_DEPARTMENT_NOT_FOUND   UserErrorReason = 403 // Department not found
	UserErrorReason_ORGANIZATION_NOT_FOUND UserErrorReason = 404 // Organization not found
	UserErrorReason_POSITION_NOT_FOUND     UserErrorReason = 405 // Position not found
	UserErrorReason_TENANT_NOT_FOUND       UserErrorReason = 406 // Tenant not found
	// 405
	UserErrorReason_METHOD_NOT_ALLOWED UserErrorReason = 500 // Method not allowed
	// 406
	UserErrorReason_NOT_ACCEPTABLE UserErrorReason = 600 // Not acceptable
	// 407
	UserErrorReason_PROXY_AUTHENTICATION_REQUIRED UserErrorReason = 700 // Proxy authentication required
	// 408
	UserErrorReason_REQUEST_TIMEOUT UserErrorReason = 800 // Request timeout
	// 409
	UserErrorReason_CONFLICT UserErrorReason = 900 // Conflict
	// 410
	UserErrorReason_GONE UserErrorReason = 1000 // Gone
	// 411
	UserErrorReason_LENGTH_REQUIRED UserErrorReason = 1010 // Content-Length required
	// 412
	UserErrorReason_PRECONDITION_FAILED UserErrorReason = 1020 // Precondition failed
	// 413
	UserErrorReason_PAYLOAD_TOO_LARGE UserErrorReason = 1030 // Payload too large
	// 414
	UserErrorReason_URI_TOO_LONG UserErrorReason = 1040 // URI too long
	// 415
	UserErrorReason_UNSUPPORTED_MEDIA_TYPE UserErrorReason = 1050 // Unsupported media type
	// 416
	UserErrorReason_RANGE_NOT_SATISFIABLE UserErrorReason = 1060 // Range not satisfiable
	// 417
	UserErrorReason_EXPECTATION_FAILED UserErrorReason = 1070 // Expectation failed
	// 418
	UserErrorReason_IM_A_TEAPOT UserErrorReason = 1080 // I'm a teapot (RFC 2324)
	// 421
	UserErrorReason_MISDIRECTED_REQUEST UserErrorReason = 1090 // Misdirected request
	// 422
	UserErrorReason_UNPROCESSABLE_ENTITY UserErrorReason = 1100 // Unprocessable entity
	// 423
	UserErrorReason_LOCKED UserErrorReason = 1110 // Locked
	// 424
	UserErrorReason_FAILED_DEPENDENCY UserErrorReason = 1120 // Failed dependency
	// 425
	UserErrorReason_TOO_EARLY UserErrorReason = 1130 // Too early
	// 426
	UserErrorReason_UPGRADE_REQUIRED UserErrorReason = 1140 // Upgrade required
	// 428
	UserErrorReason_PRECONDITION_REQUIRED UserErrorReason = 1150 // Precondition required
	// 429
	UserErrorReason_TOO_MANY_REQUESTS UserErrorReason = 1160 // Too many requests
	// 431
	UserErrorReason_REQUEST_HEADER_FIELDS_TOO_LARGE UserErrorReason = 1170 // Request header fields too large
	// 451
	UserErrorReason_UNAVAILABLE_FOR_LEGAL_REASONS UserErrorReason = 1180 // Unavailable for legal reasons
	// 500
	UserErrorReason_INTERNAL_SERVER_ERROR UserErrorReason = 2000 // Internal server error
	// 501
	UserErrorReason_NOT_IMPLEMENTED UserErrorReason = 2100 // Not implemented
	// 502
	UserErrorReason_BAD_GATEWAY UserErrorReason = 2200 // Bad gateway
	// 503
	UserErrorReason_SERVICE_UNAVAILABLE UserErrorReason = 2300 // Service unavailable
	// 504
	UserErrorReason_GATEWAY_TIMEOUT UserErrorReason = 2400 // Gateway timeout
	// 505
	UserErrorReason_HTTP_VERSION_NOT_SUPPORTED UserErrorReason = 2500 // HTTP version not supported
	// 506
	UserErrorReason_VARIANT_ALSO_NEGOTIATES UserErrorReason = 2600 // Variant also negotiates
	// 507
	UserErrorReason_INSUFFICIENT_STORAGE UserErrorReason = 2700 // Insufficient storage
	// 508
	UserErrorReason_LOOP_DETECTED UserErrorReason = 2800 // Loop detected
	// 510
	UserErrorReason_NOT_EXTENDED UserErrorReason = 2900 // Not extended
	// 511
	UserErrorReason_NETWORK_AUTHENTICATION_REQUIRED UserErrorReason = 3000 // Network authentication required
	// 598
	UserErrorReason_NETWORK_READ_TIMEOUT_ERROR UserErrorReason = 3100 // Network read timeout
	// 599
	UserErrorReason_NETWORK_CONNECT_TIMEOUT_ERROR UserErrorReason = 3200 // Network connect timeout
)
...
const file_user_service_v1_user_error_proto_rawDesc = "" +
	...
	"\x13com.user.service.v1B\x0eUserErrorProtoP\x01ZGgithub.com/go-tangra/go-tangra-portal/api/gen/go/user/service/v1;userpb\xa2\x02\x03USX\xaa\x02\x0fUser.Service.V1\xca\x02\x0fUser\\Service\\V1\xe2\x02\x1bUser\\Service\\V1\\GPBMetadata\xea\x02\x11User::Service::V1b\x06proto3"
