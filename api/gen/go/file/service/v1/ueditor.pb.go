...
const (
	UEditorAction_config       UEditorAction = 0  // Configuration
	UEditorAction_listFile     UEditorAction = 1  // Files
	UEditorAction_listImage    UEditorAction = 2  // Images
	UEditorAction_uploadFile   UEditorAction = 10 // File
	UEditorAction_uploadImage  UEditorAction = 11 // Image
	UEditorAction_uploadVideo  UEditorAction = 12 // Video
	UEditorAction_uploadScrawl UEditorAction = 13 // Scrawl image
	UEditorAction_catchImage   UEditorAction = 14 // Catch remote image
)
...
type UEditorResponse struct {
	state                   protoimpl.MessageState         `protogen:"open.v1"`
	ImageActionName         *string                        `protobuf:"bytes,1,opt,name=imageActionName,proto3,oneof" json:"imageActionName,omitempty"`                  // Action name for uploading images
	ImageFieldName          *string                        `protobuf:"bytes,2,opt,name=imageFieldName,proto3,oneof" json:"imageFieldName,omitempty"`                    // Image form field name
	ImageMaxSize            *int64                         `protobuf:"varint,3,opt,name=imageMaxSize,proto3,oneof" json:"imageMaxSize,omitempty"`                       // Upload size limit in bytes
	ImageAllowFiles         []string                       `protobuf:"bytes,4,rep,name=imageAllowFiles,proto3" json:"imageAllowFiles,omitempty"`                        // Allowed image formats
	ImageCompressEnable     *bool                          `protobuf:"varint,5,opt,name=imageCompressEnable,proto3,oneof" json:"imageCompressEnable,omitempty"`         // Whether to compress images, default is true
	ImageCompressBorder     *int64                         `protobuf:"varint,6,opt,name=imageCompressBorder,proto3,oneof" json:"imageCompressBorder,omitempty"`         // Maximum edge length for image compression
	ImageInsertAlign        *string                        `protobuf:"bytes,7,opt,name=imageInsertAlign,proto3,oneof" json:"imageInsertAlign,omitempty"`                // Image float alignment when inserted
	ImageUrlPrefix          *string                        `protobuf:"bytes,8,opt,name=imageUrlPrefix,proto3,oneof" json:"imageUrlPrefix,omitempty"`                    // Image access path prefix
	ImagePathFormat         *string                        `protobuf:"bytes,9,opt,name=imagePathFormat,proto3,oneof" json:"imagePathFormat,omitempty"`                  // Upload save path, can customize save path and filename format
	ScrawlActionName        *string                        `protobuf:"bytes,10,opt,name=scrawlActionName,proto3,oneof" json:"scrawlActionName,omitempty"`               // Action name for uploading scrawl
	ScrawlFieldName         *string                        `protobuf:"bytes,11,opt,name=scrawlFieldName,proto3,oneof" json:"scrawlFieldName,omitempty"`                 // Scrawl form field name
	ScrawlMaxSize           *int64                         `protobuf:"varint,12,opt,name=scrawlMaxSize,proto3,oneof" json:"scrawlMaxSize,omitempty"`                    // Upload size limit in bytes
	ScrawlUrlPrefix         *string                        `protobuf:"bytes,13,opt,name=scrawlUrlPrefix,proto3,oneof" json:"scrawlUrlPrefix,omitempty"`                 // Image access path prefix
	ScrawlInsertAlign       *string                        `protobuf:"bytes,14,opt,name=scrawlInsertAlign,proto3,oneof" json:"scrawlInsertAlign,omitempty"`             //
	ScrawlPathFormat        *string                        `protobuf:"bytes,15,opt,name=scrawlPathFormat,proto3,oneof" json:"scrawlPathFormat,omitempty"`               // Upload save path, can customize save path and filename format
	SnapscreenActionName    *string                        `protobuf:"bytes,20,opt,name=snapscreenActionName,proto3,oneof" json:"snapscreenActionName,omitempty"`       // Action name for uploading screenshots
	SnapscreenUrlPrefix     *string                        `protobuf:"bytes,21,opt,name=snapscreenUrlPrefix,proto3,oneof" json:"snapscreenUrlPrefix,omitempty"`         // Image access path prefix
	SnapscreenInsertAlign   *string                        `protobuf:"bytes,22,opt,name=snapscreenInsertAlign,proto3,oneof" json:"snapscreenInsertAlign,omitempty"`     // Image float alignment when inserted
	SnapscreenPathFormat    *string                        `protobuf:"bytes,23,opt,name=snapscreenPathFormat,proto3,oneof" json:"snapscreenPathFormat,omitempty"`       // Upload save path, can customize save path and filename format
	CatcherActionName       *string                        `protobuf:"bytes,30,opt,name=catcherActionName,proto3,oneof" json:"catcherActionName,omitempty"`             // Action name for catching remote images
	CatcherFieldName        *string                        `protobuf:"bytes,31,opt,name=catcherFieldName,proto3,oneof" json:"catcherFieldName,omitempty"`               // Image list form field name
	CatcherLocalDomain      []string                       `protobuf:"bytes,32,rep,name=catcherLocalDomain,proto3" json:"catcherLocalDomain,omitempty"`                 //
	CatcherUrlPrefix        *string                        `protobuf:"bytes,33,opt,name=catcherUrlPrefix,proto3,oneof" json:"catcherUrlPrefix,omitempty"`               // Image access path prefix
	CatcherMaxSize          *int64                         `protobuf:"varint,34,opt,name=catcherMaxSize,proto3,oneof" json:"catcherMaxSize,omitempty"`                  // Upload size limit in bytes
	CatcherAllowFiles       []string                       `protobuf:"bytes,35,rep,name=catcherAllowFiles,proto3" json:"catcherAllowFiles,omitempty"`                   // Allowed file types
	CatcherPathFormat       *string                        `protobuf:"bytes,36,opt,name=catcherPathFormat,proto3,oneof" json:"catcherPathFormat,omitempty"`             // Upload save path, can customize save path and filename format
	VideoActionName         *string                        `protobuf:"bytes,40,opt,name=videoActionName,proto3,oneof" json:"videoActionName,omitempty"`                 // Action name for uploading videos
	VideoFieldName          *string                        `protobuf:"bytes,41,opt,name=videoFieldName,proto3,oneof" json:"videoFieldName,omitempty"`                   // Video form field name
	VideoUrlPrefix          *string                        `protobuf:"bytes,42,opt,name=videoUrlPrefix,proto3,oneof" json:"videoUrlPrefix,omitempty"`                   // Video access path prefix
	VideoMaxSize            *int64                         `protobuf:"varint,43,opt,name=videoMaxSize,proto3,oneof" json:"videoMaxSize,omitempty"`                      // Upload size limit in bytes, default 100MB
	VideoAllowFiles         []string                       `protobuf:"bytes,44,rep,name=videoAllowFiles,proto3" json:"videoAllowFiles,omitempty"`                       // Allowed file types
	VideoPathFormat         *string                        `protobuf:"bytes,45,opt,name=videoPathFormat,proto3,oneof" json:"videoPathFormat,omitempty"`                 // Upload save path, can customize save path and filename format
	FileActionName          *string                        `protobuf:"bytes,50,opt,name=fileActionName,proto3,oneof" json:"fileActionName,omitempty"`                   // Action name for uploading files
	FileFieldName           *string                        `protobuf:"bytes,51,opt,name=fileFieldName,proto3,oneof" json:"fileFieldName,omitempty"`                     // File form field name
	FileUrlPrefix           *string                        `protobuf:"bytes,52,opt,name=fileUrlPrefix,proto3,oneof" json:"fileUrlPrefix,omitempty"`                     // File access path prefix
	FileMaxSize             *int64                         `protobuf:"varint,53,opt,name=fileMaxSize,proto3,oneof" json:"fileMaxSize,omitempty"`                        // Upload size limit in bytes, default 50MB
	FileAllowFiles          []string                       `protobuf:"bytes,54,rep,name=fileAllowFiles,proto3" json:"fileAllowFiles,omitempty"`                         // Allowed file types
	FilePathFormat          *string                        `protobuf:"bytes,55,opt,name=filePathFormat,proto3,oneof" json:"filePathFormat,omitempty"`                   // Upload save path, can customize save path and filename format
	ImageManagerActionName  *string                        `protobuf:"bytes,60,opt,name=imageManagerActionName,proto3,oneof" json:"imageManagerActionName,omitempty"`   // Image list configuration
	ImageManagerListSize    *int64                         `protobuf:"varint,61,opt,name=imageManagerListSize,proto3,oneof" json:"imageManagerListSize,omitempty"`      // Number of files to list per request
	ImageManagerUrlPrefix   *string                        `protobuf:"bytes,62,opt,name=imageManagerUrlPrefix,proto3,oneof" json:"imageManagerUrlPrefix,omitempty"`     // Image access path prefix
	ImageManagerInsertAlign *string                        `protobuf:"bytes,63,opt,name=imageManagerInsertAlign,proto3,oneof" json:"imageManagerInsertAlign,omitempty"` // Image float alignment when inserted, default: none
	ImageManagerAllowFiles  []string                       `protobuf:"bytes,64,rep,name=imageManagerAllowFiles,proto3" json:"imageManagerAllowFiles,omitempty"`         // Allowed file types
	ImageManagerListPath    *string                        `protobuf:"bytes,65,opt,name=imageManagerListPath,proto3,oneof" json:"imageManagerListPath,omitempty"`       // Directory to list images from
	FileManagerActionName   *string                        `protobuf:"bytes,70,opt,name=fileManagerActionName,proto3,oneof" json:"fileManagerActionName,omitempty"`     // File list configuration
	FileManagerUrlPrefix    *string                        `protobuf:"bytes,71,opt,name=fileManagerUrlPrefix,proto3,oneof" json:"fileManagerUrlPrefix,omitempty"`       // Directory to list files from
	FileManagerListSize     *int64                         `protobuf:"varint,72,opt,name=fileManagerListSize,proto3,oneof" json:"fileManagerListSize,omitempty"`        // Number of files to list per request
	FileManagerAllowFiles   []string                       `protobuf:"bytes,73,rep,name=fileManagerAllowFiles,proto3" json:"fileManagerAllowFiles,omitempty"`           // Allowed file types
	FileManagerListPath     *string                        `protobuf:"bytes,74,opt,name=FileManagerListPath,proto3,oneof" json:"FileManagerListPath,omitempty"`         // Allowed file types
	FormulaConfig           *UEditorResponse_FormulaConfig `protobuf:"bytes,80,opt,name=formulaConfig,proto3,oneof" json:"formulaConfig,omitempty"`                     // Formula configuration
	State                   *string                        `protobuf:"bytes,100,opt,name=state,proto3,oneof" json:"state,omitempty"`                                    // Upload state, must return "SUCCESS" on successful upload
...
type UEditorUploadRequest struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	Action         *string                `protobuf:"bytes,1,opt,name=action,proto3,oneof" json:"action,omitempty"`                                         // Action
	File           []byte                 `protobuf:"bytes,2,opt,name=file,proto3,oneof" json:"file,omitempty"`                                             // File content
	SourceFileName *string                `protobuf:"bytes,3,opt,name=source_file_name,json=sourceFileName,proto3,oneof" json:"source_file_name,omitempty"` // Original file name
	Mime           *string                `protobuf:"bytes,4,opt,name=mime,proto3,oneof" json:"mime,omitempty"`                                             // MIME type of the file
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
type UEditorUploadResponse struct {
	state         protoimpl.MessageState        `protogen:"open.v1"`
	State         *string                       `protobuf:"bytes,1,opt,name=state,proto3,oneof" json:"state,omitempty"`       // Upload state, must return "SUCCESS" on successful upload
	Url           *string                       `protobuf:"bytes,2,opt,name=url,proto3,oneof" json:"url,omitempty"`           // Returned URL
	Title         *string                       `protobuf:"bytes,3,opt,name=title,proto3,oneof" json:"title,omitempty"`       // New file name
	Original      *string                       `protobuf:"bytes,4,opt,name=original,proto3,oneof" json:"original,omitempty"` // Original file name
	Type          *string                       `protobuf:"bytes,5,opt,name=type,proto3,oneof" json:"type,omitempty"`         // File type
	Size          *int32                        `protobuf:"varint,6,opt,name=size,proto3,oneof" json:"size,omitempty"`        // File size
...
type UEditorResponse_FormulaConfig struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	ImageUrlTemplate string                 `protobuf:"bytes,1,opt,name=imageUrlTemplate,proto3" json:"imageUrlTemplate,omitempty"` // Formula rendering path
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
type UEditorUploadResponse_Item struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	State         string                 `protobuf:"bytes,1,opt,name=state,proto3" json:"state,omitempty"`             // Upload state, must return "SUCCESS" on successful upload
	Url           *string                `protobuf:"bytes,2,opt,name=url,proto3,oneof" json:"url,omitempty"`           // Returned URL
	Title         *string                `protobuf:"bytes,3,opt,name=title,proto3,oneof" json:"title,omitempty"`       // New file name
	Original      *string                `protobuf:"bytes,4,opt,name=original,proto3,oneof" json:"original,omitempty"` // Original file name
	Type          *string                `protobuf:"bytes,5,opt,name=type,proto3,oneof" json:"type,omitempty"`         // File type
...
const file_file_service_v1_ueditor_proto_rawDesc = "" +
	...
	"\x06action\x18\x01 \x01(\tB\f\xbaG\t\x92\x02\x06ActionH\x00R\x06action\x88\x01\x01\x12+\n" +
	"\x04file\x18\x02 \x01(\fB\x12\xbaG\x0f\x92\x02\fFile contentH\x01R\x04file\x88\x01\x01\x12G\n" +
	"\x10source_file_name\x18\x03 \x01(\tB\x18\xbaG\x15\x92\x02\x12Original file nameH\x02R\x0esourceFileName\x88\x01\x01\x124\n" +
	"\x04mime\x18\x04 \x01(\tB\x1b\xbaG\x18\x92\x02\x15MIME type of the fileH\x03R\x04mime\x88\x01\x01B\t\n" +
	"\a_actionB\a\n" +
	"\x05_fileB\x13\n" +
	...
	"\n" +
	"UploadFile\x12%.file.service.v1.UEditorUploadRequest\x1a&.file.service.v1.UEditorUploadResponse\"\x00B\xca\x01\n" +
	"\x13com.file.service.v1B\fUeditorProtoP\x01ZGgithub.com/go-tangra/go-tangra-portal/api/gen/go/file/service/v1;filepb\xa2\x02\x03FSX\xaa\x02\x0fFile.Service.V1\xca\x02\x0fFile\\Service\\V1\xe2\x02\x1bFile\\Service\\V1\\GPBMetadata\xea\x02\x11File::Service::V1b\x06proto3"
