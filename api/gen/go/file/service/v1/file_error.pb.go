...
// FileErrorReason File System Error Definitions
type FileErrorReason int32

const (
	// 400
	FileErrorReason_BAD_REQUEST FileErrorReason = 0 // Bad request
	// 401
	FileErrorReason_UNAUTHORIZED FileErrorReason = 100 // Unauthorized
	// 402
	FileErrorReason_PAYMENT_REQUIRED FileErrorReason = 200 // Payment required
	// 403
	FileErrorReason_FORBIDDEN FileErrorReason = 300 // Forbidden
	// 404
	FileErrorReason_NOT_FOUND      FileErrorReason = 400 // Resource not found
	FileErrorReason_FILE_NOT_FOUND FileErrorReason = 401 // File not found
	// 405
	FileErrorReason_METHOD_NOT_ALLOWED FileErrorReason = 500 // Method not allowed
	// 406
	FileErrorReason_NOT_ACCEPTABLE FileErrorReason = 600 // Not acceptable request
	// 407
	FileErrorReason_PROXY_AUTHENTICATION_REQUIRED FileErrorReason = 700 // Proxy authentication required
	// 408
	FileErrorReason_REQUEST_TIMEOUT FileErrorReason = 800 // Request timeout
	// 409
	FileErrorReason_CONFLICT FileErrorReason = 900 // Conflict
	// 410
	FileErrorReason_GONE FileErrorReason = 1000 // Gone
	// 411
	FileErrorReason_LENGTH_REQUIRED FileErrorReason = 1010 // Content-Length required
	// 412
	FileErrorReason_PRECONDITION_FAILED FileErrorReason = 1020 // Precondition failed
	// 413
	FileErrorReason_PAYLOAD_TOO_LARGE FileErrorReason = 1030 // Payload too large
	FileErrorReason_FILE_TOO_LARGE    FileErrorReason = 1031 // File too large
	// 414
	FileErrorReason_URI_TOO_LONG FileErrorReason = 1040 // URI too long
	// 415
	FileErrorReason_UNSUPPORTED_MEDIA_TYPE FileErrorReason = 1050 // Unsupported media type
	// 416
	FileErrorReason_RANGE_NOT_SATISFIABLE FileErrorReason = 1060 // Range not satisfiable
	// 417
	FileErrorReason_EXPECTATION_FAILED FileErrorReason = 1070 // Expectation failed
	// 418
	FileErrorReason_IM_A_TEAPOT FileErrorReason = 1080 // I'm a teapot (RFC 2324)
	// 421
	FileErrorReason_MISDIRECTED_REQUEST FileErrorReason = 1090 // Misdirected request
	// 422
	FileErrorReason_UNPROCESSABLE_ENTITY FileErrorReason = 1100 // Unprocessable entity
	// 423
	FileErrorReason_LOCKED FileErrorReason = 1110 // Locked
	// 424
	FileErrorReason_FAILED_DEPENDENCY FileErrorReason = 1120 // Failed dependency
	// 425
	FileErrorReason_TOO_EARLY FileErrorReason = 1130 // Too early
	// 426
	FileErrorReason_UPGRADE_REQUIRED FileErrorReason = 1140 // Upgrade required
	// 428
	FileErrorReason_PRECONDITION_REQUIRED FileErrorReason = 1150 // Precondition required
	// 429
	FileErrorReason_TOO_MANY_REQUESTS FileErrorReason = 1160 // Too many requests
	// 431
	FileErrorReason_REQUEST_HEADER_FIELDS_TOO_LARGE FileErrorReason = 1170 // Request header fields too large
	// 451
	FileErrorReason_UNAVAILABLE_FOR_LEGAL_REASONS FileErrorReason = 1180 // Unavailable for legal reasons
	// 500
	FileErrorReason_INTERNAL_SERVER_ERROR FileErrorReason = 2000 // Internal server error
	...
	// 501
	FileErrorReason_NOT_IMPLEMENTED FileErrorReason = 2100 // Not implemented
	// 502
	FileErrorReason_BAD_GATEWAY FileErrorReason = 2200 // Bad gateway
	// 503
	FileErrorReason_SERVICE_UNAVAILABLE FileErrorReason = 2300 // Service unavailable
	// 504
	FileErrorReason_GATEWAY_TIMEOUT FileErrorReason = 2400 // Gateway timeout
	// 505
	FileErrorReason_HTTP_VERSION_NOT_SUPPORTED FileErrorReason = 2500 // HTTP version not supported
	// 506
	FileErrorReason_VARIANT_ALSO_NEGOTIATES FileErrorReason = 2600 // Variant also negotiates
	// 507
	FileErrorReason_INSUFFICIENT_STORAGE FileErrorReason = 2700 // Insufficient storage
	// 508
	FileErrorReason_LOOP_DETECTED FileErrorReason = 2800 // Loop detected
	// 510
	FileErrorReason_NOT_EXTENDED FileErrorReason = 2900 // Not extended
	// 511
	FileErrorReason_NETWORK_AUTHENTICATION_REQUIRED FileErrorReason = 3000 // Network authentication required
	// 598
	FileErrorReason_NETWORK_READ_TIMEOUT_ERROR FileErrorReason = 3100 // Network read timeout
	// 599
	FileErrorReason_NETWORK_CONNECT_TIMEOUT_ERROR FileErrorReason = 3200 // Network connect timeout
)
...
const file_file_service_v1_file_error_proto_rawDesc = "" +
	...
	"\x13com.file.service.v1B\x0eFileErrorProtoP\x01ZGgithub.com/go-tangra/go-tangra-portal/api/gen/go/file/service/v1;filepb\xa2\x02\x03FSX\xaa\x02\x0fFile.Service.V1\xca\x02\x0fFile\\Service\\V1\xe2\x02\x1bFile\\Service\\V1\\GPBMetadata\xea\x02\x11File::Service::V1b\x06proto3"
