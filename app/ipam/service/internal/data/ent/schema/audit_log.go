...
// This stores audit logs for IPAM operations with cryptographic integrity.
...
func (AuditLog) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "ipam_audit_logs"},
...
func (AuditLog) Indexes() []ent.Index {
	return []ent.Index{
		index.Fields("tenant_id").StorageKey("ipam_auditlog_tenant_id"),
		index.Fields("tenant_id", "client_id").StorageKey("ipam_auditlog_tenant_client"),
		index.Fields("tenant_id", "operation").StorageKey("ipam_auditlog_tenant_operation"),
		index.Fields("tenant_id", "success").StorageKey("ipam_auditlog_tenant_success"),
		index.Fields("operation").StorageKey("ipam_auditlog_operation"),
		index.Fields("client_id").StorageKey("ipam_auditlog_client_id"),
		index.Fields("success").StorageKey("ipam_auditlog_success"),
		index.Fields("peer_address").StorageKey("ipam_auditlog_peer_address"),
	}
}
