...
import (
	...
	"github.com/go-tangra/go-tangra-portal/app/admin/service/internal/data/ent/internalmessagecategory"
	"github.com/go-tangra/go-tangra-portal/app/admin/service/internal/data/ent/predicate"

	"github.com/tx7do/go-utils/copierutil"
	"github.com/tx7do/go-utils/mapper"

	internalMessageV1 "github.com/go-tangra/go-tangra-portal/api/gen/go/internal_message/service/v1"
)
...
func (r *InternalMessageCategoryRepo) Delete(ctx context.Context, req *internalMessageV1.DeleteInternalMessageCategoryRequest) error {
	...
	ids, err := QueryAllChildrenIds(ctx, r.entClient, "internal_message_categories", req.GetId())
	if err != nil {
	...
	_, err = r.repository.Delete(ctx, builder, func(s *sql.Selector) {
		s.Where(sql.In(internalmessagecategory.FieldID, idsAny...))
	})
	if err != nil {
