...
import (
	...
	"github.com/go-tangra/go-tangra-portal/app/admin/service/internal/data/ent/permissionpolicy"
...
var schemaGraph = func() *sqlgraph.Schema {
	...
	graph.Nodes[34] = &sqlgraph.Node{
		...
		Fields: map[string]*sqlgraph.FieldSpec{
			...
			user.FieldTimeFormat:  {Type: field.TypeString, Column: user.FieldTimeFormat},
...
// WhereCreatedAt applies the entql time.Time predicate on the created_at field.
func (f *ModuleFilter) WhereCreatedAt(p entql.TimeP) {
	f.Where(p.Field(module.FieldCreatedAt))
}

// WhereUpdatedAt applies the entql time.Time predicate on the updated_at field.
func (f *ModuleFilter) WhereUpdatedAt(p entql.TimeP) {
	f.Where(p.Field(module.FieldUpdatedAt))
}

// WhereDeletedAt applies the entql time.Time predicate on the deleted_at field.
func (f *ModuleFilter) WhereDeletedAt(p entql.TimeP) {
	f.Where(p.Field(module.FieldDeletedAt))
}

// WhereCreatedBy applies the entql uint32 predicate on the created_by field.
func (f *ModuleFilter) WhereCreatedBy(p entql.Uint32P) {
	f.Where(p.Field(module.FieldCreatedBy))
}

// WhereUpdatedBy applies the entql uint32 predicate on the updated_by field.
func (f *ModuleFilter) WhereUpdatedBy(p entql.Uint32P) {
	f.Where(p.Field(module.FieldUpdatedBy))
}

// WhereDeletedBy applies the entql uint32 predicate on the deleted_by field.
func (f *ModuleFilter) WhereDeletedBy(p entql.Uint32P) {
	f.Where(p.Field(module.FieldDeletedBy))
}

// WhereModuleID applies the entql string predicate on the module_id field.
func (f *ModuleFilter) WhereModuleID(p entql.StringP) {
	f.Where(p.Field(module.FieldModuleID))
}

// WhereModuleName applies the entql string predicate on the module_name field.
func (f *ModuleFilter) WhereModuleName(p entql.StringP) {
	f.Where(p.Field(module.FieldModuleName))
}
...
// WhereGrpcEndpoint applies the entql string predicate on the grpc_endpoint field.
func (f *ModuleFilter) WhereGrpcEndpoint(p entql.StringP) {
	f.Where(p.Field(module.FieldGrpcEndpoint))
}

// WhereStatus applies the entql int32 predicate on the status field.
func (f *ModuleFilter) WhereStatus(p entql.Int32P) {
	f.Where(p.Field(module.FieldStatus))
}

// WhereHealth applies the entql int32 predicate on the health field.
func (f *ModuleFilter) WhereHealth(p entql.Int32P) {
	f.Where(p.Field(module.FieldHealth))
}

// WhereOpenapiSpec applies the entql []byte predicate on the openapi_spec field.
func (f *ModuleFilter) WhereOpenapiSpec(p entql.BytesP) {
	f.Where(p.Field(module.FieldOpenapiSpec))
}

// WhereProtoDescriptor applies the entql []byte predicate on the proto_descriptor field.
func (f *ModuleFilter) WhereProtoDescriptor(p entql.BytesP) {
	f.Where(p.Field(module.FieldProtoDescriptor))
}
...
func (f *ModuleFilter) WhereRegistrationID(p entql.StringP) {
	f.Where(p.Field(module.FieldRegistrationID))
}

// WhereRegisteredAt applies the entql time.Time predicate on the registered_at field.
func (f *ModuleFilter) WhereRegisteredAt(p entql.TimeP) {
	f.Where(p.Field(module.FieldRegisteredAt))
}

// WhereLastHeartbeat applies the entql time.Time predicate on the last_heartbeat field.
func (f *ModuleFilter) WhereLastHeartbeat(p entql.TimeP) {
	f.Where(p.Field(module.FieldLastHeartbeat))
}

// WhereMenuCount applies the entql int32 predicate on the menu_count field.
func (f *ModuleFilter) WhereMenuCount(p entql.Int32P) {
	f.Where(p.Field(module.FieldMenuCount))
}

// WhereAPICount applies the entql int32 predicate on the api_count field.
func (f *ModuleFilter) WhereAPICount(p entql.Int32P) {
	f.Where(p.Field(module.FieldAPICount))
}

// WhereRouteCount applies the entql int32 predicate on the route_count field.
func (f *ModuleFilter) WhereRouteCount(p entql.Int32P) {
	f.Where(p.Field(module.FieldRouteCount))
}
...
// WhereTimeZone applies the entql string predicate on the time_zone field.
func (f *UserFilter) WhereTimeZone(p entql.StringP) {
	f.Where(p.Field(user.FieldTimeZone))
}

// WhereTimeFormat applies the entql string predicate on the time_format field.
func (f *UserFilter) WhereTimeFormat(p entql.StringP) {
	f.Where(p.Field(user.FieldTimeFormat))
}
