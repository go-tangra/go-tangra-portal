...
func init() {
	...
	_ = moduleFields
	// moduleDescModuleID is the schema descriptor for module_id field.
	moduleDescModuleID := moduleFields[0].Descriptor()
	// module.ModuleIDValidator is a validator for the "module_id" field. It is called by the builders before save.
	module.ModuleIDValidator = moduleDescModuleID.Validators[0].(func(string) error)
	// moduleDescModuleName is the schema descriptor for module_name field.
	moduleDescModuleName := moduleFields[1].Descriptor()
	// module.ModuleNameValidator is a validator for the "module_name" field. It is called by the builders before save.
	module.ModuleNameValidator = moduleDescModuleName.Validators[0].(func(string) error)
	// moduleDescVersion is the schema descriptor for version field.
	moduleDescVersion := moduleFields[2].Descriptor()
	// module.DefaultVersion holds the default value on creation for the version field.
	module.DefaultVersion = moduleDescVersion.Default.(string)
	// moduleDescGrpcEndpoint is the schema descriptor for grpc_endpoint field.
	moduleDescGrpcEndpoint := moduleFields[4].Descriptor()
	// module.GrpcEndpointValidator is a validator for the "grpc_endpoint" field. It is called by the builders before save.
	module.GrpcEndpointValidator = moduleDescGrpcEndpoint.Validators[0].(func(string) error)
	// moduleDescStatus is the schema descriptor for status field.
	moduleDescStatus := moduleFields[5].Descriptor()
	...
	// moduleDescHealth is the schema descriptor for health field.
	...
	// moduleDescServerName is the schema descriptor for server_name field.
	moduleDescServerName := moduleFields[12].Descriptor()
	// module.DefaultServerName holds the default value on creation for the server_name field.
	module.DefaultServerName = moduleDescServerName.Default.(string)
	// moduleDescMenuCount is the schema descriptor for menu_count field.
	moduleDescMenuCount := moduleFields[16].Descriptor()
	...
	moduleDescAPICount := moduleFields[17].Descriptor()
	...
	moduleDescRouteCount := moduleFields[18].Descriptor()
	...
	module.IDValidator = moduleDescID.Validators[0].(func(uint32) error)
