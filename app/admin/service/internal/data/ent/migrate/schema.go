...
var (
	...
	SysModulesColumns = []*schema.Column{
		...
		{Name: "updated_by", Type: field.TypeUint32, Nullable: true, Comment: "更新者ID"},
		{Name: "deleted_by", Type: field.TypeUint32, Nullable: true, Comment: "删除者ID"},
		{Name: "module_id", Type: field.TypeString, Unique: true, Comment: "Unique module identifier (e.g., 'echo', 'lcm', 'ipam')"},
		{Name: "module_name", Type: field.TypeString, Comment: "Display name of the module"},
		{Name: "version", Type: field.TypeString, Comment: "Module version (semver)", Default: "1.0.0"},
		{Name: "description", Type: field.TypeString, Nullable: true, Comment: "Module description"},
		{Name: "grpc_endpoint", Type: field.TypeString, Comment: "gRPC endpoint address (e.g., 'echo-service:9500')"},
		{Name: "status", Type: field.TypeInt32, Comment: "Module status: 1=active, 2=inactive, 3=error", Default: 1},
		{Name: "health", Type: field.TypeInt32, Comment: "Module health: 1=healthy, 2=degraded, 3=unhealthy", Default: 1},
		...
		{Name: "server_name", Type: field.TypeString, Nullable: true, Comment: "TLS server name for mTLS verification (e.g., 'warden-service')", Default: ""},
		...
		{Name: "menu_count", Type: field.TypeInt32, Comment: "Number of menus registered by this module", Default: 0},
		{Name: "api_count", Type: field.TypeInt32, Comment: "Number of API resources registered by this module", Default: 0},
		{Name: "route_count", Type: field.TypeInt32, Comment: "Number of HTTP routes registered by this module", Default: 0},
	}
	// SysModulesTable holds the schema information for the "sys_modules" table.
	SysModulesTable = &schema.Table{
		Name:       "sys_modules",
		Comment:    "Dynamic module registration table",
		Columns:    SysModulesColumns,
		PrimaryKey: []*schema.Column{SysModulesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "idx_sys_modules_status",
				Unique:  false,
				Columns: []*schema.Column{SysModulesColumns[12]},
			},
			{
				Name:    "idx_sys_modules_health",
				Unique:  false,
				Columns: []*schema.Column{SysModulesColumns[13]},
			},
			{
				Name:    "idx_sys_modules_status_health",
				Unique:  false,
				Columns: []*schema.Column{SysModulesColumns[12], SysModulesColumns[13]},
			},
			{
				Name:    "idx_sys_modules_last_heartbeat",
				Unique:  false,
				Columns: []*schema.Column{SysModulesColumns[22]},
			},
			{
				Name:    "idx_sys_modules_created_at",
				Unique:  false,
				Columns: []*schema.Column{SysModulesColumns[1]},
			},
		},
	}
...
func init() {
	...
	SysModulesTable.Annotation = &entsql.Annotation{
		Table:     "sys_modules",
		Charset:   "utf8mb4",
		Collation: "utf8mb4_bin",
	}
