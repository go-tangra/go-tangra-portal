...
import (
	...
	applogging "github.com/go-tangra/go-tangra-portal/pkg/middleware/logging"
)
...
func NewRestServer(
	...
	// Register dynamic module router for /admin/v1/modules/* paths
	// This handler supports hot-reload - modules can register/unregister without server restart
	if dynamicRouter != nil {
		// Load existing modules from registry
		dynamicRouter.LoadExistingModules()
