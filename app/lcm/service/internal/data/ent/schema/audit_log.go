...
// This stores audit logs for LCM operations with cryptographic integrity.
...
func (AuditLog) Annotations() []schema.Annotation {
	return []schema.Annotation{
		entsql.Annotation{Table: "lcm_audit_logs"},
