...
export default [
  ...
  { rules: freyaRules },
  // Transitional: the shell keeps a Vuetify instance alive for legacy remotes (ui/MIGRATION.md).
  { files: ['src/main.ts', 'src/legacy/**', 'vite.config.ts', 'tests/**'], rules: { 'no-restricted-imports': 'off' } },
]
